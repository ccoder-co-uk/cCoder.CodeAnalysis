...
public sealed class BrokerCodeAnalysisRulesProcessingServiceTests
{
    [Fact]
    public void EvaluateShouldExecuteAllConfiguredBrokerRules()
    {
        ...
        BrokerCodeAnalysisRulesProcessingService service = new BrokerCodeAnalysisRulesProcessingService();
        AnalysisItem[] results = service.Evaluate(context);
        results
