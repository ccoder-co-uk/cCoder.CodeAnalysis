...
internal sealed partial class InvalidManagementService(ISchoolImportCoordinationService importService) : IInvalidManagementService
{
...
=>
        TryCatch(operation: () =>
        {
            ...
            ISchoolImportCoordinationService schoolImportCoordinationService = importService;
            ...
            return schoolImportCoordinationService.ImportSchoolAsync(school: school2);
        });
}