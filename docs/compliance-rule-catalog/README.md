...
4. Add control-flow dominance and effect classification before implementing OWASP0001 or OWASP0002.
5. Add taint/range/response-payload data flow before implementing OWASP0003 through OWASP0005.
